...
./configure --prefix=%{INSTALL_DIR} --with-host=xalt.tacc.utexas.edu --with-reader=readerOfTips --with-pass=tipReader123 --with-db=HPCTips --with-module=tacc_tips --with-MySQL=no
