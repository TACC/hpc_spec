# $Id: matlab.spec, v2019b, 2019/09/24 siliu $ 
...
append_path("PATH", "/opt/apps/matlab/2019b/bin")

append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2019b/bin/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2019b/runtime/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2019b/sys/java/jre/glnxa64/jre/lib/amd64/server")

setenv ("TACC_MATLAB_DIR", "/opt/apps/matlab/2019b")
