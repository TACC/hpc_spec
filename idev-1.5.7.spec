...
# echo "PWD:$PWD ">>/tmp/kent
# ls -ltr >>/tmp/kent
# echo "_______________________________" >> /tmp/kent
# ls -ltr idev >>/tmp/kent
# echo "_______________________________" >> /tmp/kent
# cp idev/idev kent
# grep longhorn $PWD/idev/idev           >> /tmp/kent
...
Allows user to work directly on a compute node:
  ...
  You can execute cuda/mic code interactively (Stampede2/Lonestar5/Maverick/Longhorn).
