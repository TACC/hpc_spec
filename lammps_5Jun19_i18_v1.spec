...
#
# rpmbuild -bb --define 'is_intel18 1' --define 'is_impi 1' --define 'mpiV 18_2' lammps_5Jun19_i18_v1.spec | tee log_lammps_5Jun19
#
...
EOF
  ...
  if [[ $liblist =~ "kim" ]]; then
    ...
    # KIM-API
    mkdir -p /opt/apps/intel18/impi18_0/lammps/%{major_version}/lib/kim
    tar -xf kim-api-${KIM_VERSION}.txz
    rm kim-api-${KIM_VERSION}.txz

    mv kim-api-${KIM_VERSION} /opt/apps/intel18/impi18_0/lammps/%{major_version}/lib/kim
    cd /opt/apps/intel18/impi18_0/lammps/%{major_version}/lib/kim
...
EOF
    ...
    cp -r /opt/apps/intel18/impi18_0/lammps/%{major_version}/lib/kim/installed-kim-api .
...
EOF
  ...
  rm -rf /opt/apps/intel18/impi18_0/lammps/%{major_version}
...
The following packages were not installed:
  ...
  GPU, KOKKOS, LATTE, MESSAGE, MSCG, REAX, USER-ADIOS USER-MOLFILE, USER-QMMM
...
- LIBRARIES
  ...
  LAMMPS library liblammps_stampede.so is kept in TACC_LAMMPS_LIB/lammps.
