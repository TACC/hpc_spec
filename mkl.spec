...
local base         = "/opt/apps/intel/15"
local full_xe      = "composer_xe_2015.3.187"
...
setenv( "TACC_MKL_DOC" ,              pathJoin( installDir , "Documentation/en_US/mkl" ) )
...
prepend_path( "MANPATH" ,             pathJoin( installDir , "debugger/gdb/intel64/share/man" ) )
