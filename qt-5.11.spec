...
#------------------------
 ...
 ./configure -confirm-license --prefix=$WORK_INSTALL_DIR -opensource -avx2 -qt-xcb -release -nomake examples -nomake tests
...
[Paths]
Prefix = /opt/apps/qt5/%{pkg_version}
Plugins = /opt/apps/qt5/%{pkg_version}/plugins
EOF
