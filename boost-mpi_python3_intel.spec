...
### SiLiu Black magic: choose 59 here
...
### SiLiu Black Magic
  ...
  echo "using python : 3.9 : /opt/apps/intel19/python3/3.9.7/bin/python3.9 : /opt/apps/intel19/python3/3.9.7/include/python3.9 :  /opt/apps/intel19/python3/3.9.7/lib ;" >> tools/build/example/user-config.jam
  echo "using python : 3.9 : /opt/apps/intel19/python3/3.9.7/bin/python3.9 : /opt/apps/intel19/python3/3.9.7/include/python3.9 :  /opt/apps/intel19/python3/3.9.7/lib ;" >> user-config.jam

  ./bootstrap.sh --with-python=/opt/apps/intel19/python3/3.9.7/bin/python3.9 --with-python-version=3.9 --with-python-root=/opt/apps/intel19/python3/3.9.7 --prefix=%{INSTALL_DIR} ${CONFIGURE_FLAGS}
...
### echo "using mpi : /opt/intel/compilers_and_libraries_2019.4.243/linux/mpi/intel64/bin/mpicxx ;" >> project-config.jam
    echo "using mpi : /opt/intel/compilers_and_libraries_2020.4.304/linux/mpi/intel64/bin/mpicxx ;" >> project-config.jam

  ./b2 -j 24 include="/opt/apps/intel19/python3/3.9.7/include/python3.9" --prefix=%{PYTHON_INSTALL_DIR} $EXTRA cxxflags="%{TACC_OPT}" cflags="%{TACC_OPT}" linkflags="%{TACC_OPT}" install
