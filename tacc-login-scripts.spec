...
find fsMounted workdir | cpio -pduv --owner=root: $RPM_BUILD_ROOT/usr/local/bin/
...
find archive | cpio -pduv --owner=root:                 $RPM_BUILD_ROOT/usr/local/etc/
find $OLD_TACC_STARTUP_FILES | cpio -pduv --owner=root: $RPM_BUILD_ROOT/usr/local

find ./profile.d $PROFILE_D_FILES | cpio -pduv --owner=root: $RPM_BUILD_ROOT%{PROFILE_D_PATH}/..
...
find $SHELL_STARTUP_FILES | cpio -pduv --owner=root: $RPM_BUILD_ROOT/etc/tacc
...
find $ZSH_STARTUP_FILES | cpio -pduv --owner=root: $RPM_BUILD_ROOT/etc/tacc
