...
#------------------------
  ...
  # download caffe
  wget https://github.com/intel/caffe/archive/1.1.1.tar.gz
  tar zxf 1.1.1.tar.gz
  pushd caffe-1.1.1

  # download libraries
  git clone -b caffe-v1.1.1 --single-branch https://github.com/zhaozhang/caffe-stampede2.git
  ...
  CC=icc CXX=icpc ./configure --prefix=/admin/build/rpms/BUILD/caffe-1.1.1/caffe-stampede2/libraries/protocol-buffer-build
  make
  make install
  export PATH=/admin/build/rpms/BUILD/caffe-1.1.1/caffe-stampede2/libraries/protocol-buffer-build/bin:$PATH
  popd
  popd
  popd
  ...
  cp -r external/ideep/ideep/dlcp/include caffe-stampede2/libraries/dlcp/
  cp -r external/ideep/ideep/dlcp/lib caffe-stampede2/libraries/dlcp/

  cp -r external/mkl/mklml_lnx_2018.0.1.20171227 caffe-stampede2/libraries/mklml

  cp -r external/mkldnn/install caffe-stampede2/libraries/mkldnn

  mkdir caffe-stampede2/libraries/mlsl
  cp -r external/mlsl/l_mlsl_2018.0.003/intel64 caffe-stampede2/libraries/mlsl/
