...
Packager:  TACC - mcawood@tacc.utexas.edu
...
export help2man_major=1
export help2man_minor=48
export help2man_path=5
...
export autoconf_minor=71

export automake_major=1
export automake_minor=16
export automake_patch=4

export libtool_major=2
export libtool_minor=4
export libtool_patch=6

export help2man_version=${help2man_major}.${help2man_minor}.${help2man_path}
export       m4_version=${m4_major}.${m4_minor}.${m4_patch}
export autoconf_version=${autoconf_major}.${autoconf_minor}
export automake_version=${automake_major}.${automake_minor}.${automake_patch}
...
### HELP2MAN
cd ${auto}
wget http://ftp.gnu.org/gnu/help2man/help2man-${help2man_version}.tar.xz
tar xvf help2man-${help2man_version}.tar.xz
cd help2man-${help2man_version}
${auto}/help2man-${help2man_version}/configure \
--prefix=${auto_install}
make -j ${ncores}
make -j ${ncores} install

export PATH=$PATH:${auto_install}/bin
...
cd ${auto}
wget https://distfiles.dereferenced.org/pkgconf/pkgconf-1.8.0.tar.gz
tar xvf pkgconf-1.8.0.tar.gz
cp pkgconf-1.8.0/pkg.m4 %{INSTALL_DIR}/share/aclocal
...
# Set autotools default version 1.2

cat > $RPM_BUILD_ROOT/%{MODULE_DIR}/.modulerc << 'EOF'
#%Module
module-version autotools/1.2 default
EOF

# Write out the modulefile associated with the application
cat > $RPM_BUILD_ROOT/%{MODULE_DIR}/%{MODULE_FILENAME} << 'EOF'
local help_msg=[[
Autotools assists a software development person or team to write cross-platform
software and make it available to a much wider user community, including in its
source code form to those users who wish to build the software themselves.
