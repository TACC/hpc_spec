...
if [ $TACC_FAMILY_PYTHON -eq "python2" ] ; then
  export PYLIB=${TACC_PYTHON_LIB}/libpython${TACC_PYTHON_VER:=2.7}.so
else
  export TACC_PYTHON_LIB=$TACC_PYTHON3_LIB
...
%changelog
* Wed Feb 03 2021 eijkhout <eijkhout@tacc.utexas.edu>
- release 6: adding parmesh
* Tue Jan 05 2021 eijkhout <eijkhout@tacc.utexas.edu>
- release 4: 1.6.0 on petsc 3.14
* Fri May 03 2019 eijkhout <eijkhout@tacc.utexas.edu>
- release 3: 1.4.0 INCOMPATIBLE with petsc 3.11
