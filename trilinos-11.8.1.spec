...
export TRILINOS_PACKAGES=" \
  ...
  "
export MAYBE_TRILINOS_PACKAGES=" \
...
# 12.2 flags that do not apply to 11.8
export cmake_disbled="\
...
%changelog
#
* Wed Feb 27 2019 eijkhout <eijkhout@tacc.utexas.edu>
- release 1: backwards for user
