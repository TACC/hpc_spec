#
# rpmbuild -bb --define 'is_intel19 1' --define 'is_impi 1' --define 'mpiV 19_4' gromacs2018.3.spec 2>&1 | tee gromacs2018.3.spec_r#_a.log

# r=/admin/build/admin/rpms/frontera/RPMS/x86_64
#rpm -hiv --relocate /tmprpm=/opt/apps  $r/tacc-gromacs-intel19-impi19_0-package-2018.3-1.el7.x86_64.rpm
#rpm -hiv --relocate /tmpmod=/opt/apps  $r/tacc-gromacs-intel19-impi19_0-modulefile-2018.3-1.el7.x86_64.rpm
# removed --nodeps
