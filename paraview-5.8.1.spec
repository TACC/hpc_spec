...
if test ! -e %{_topdir}/BUILD/Paraview/ParaView-v%{pkg_version} ; then
...
#------------------------
  ...
  CC=icc CXX=icpc cmake .. \
    ...
    -DBoost_INCLUDE_DIR=/opt/apps/intel18/boost/1.68/include \
...
echo XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
  ...
  cp -r $RPM_BUILD_ROOT/%{INSTALL_DIR} /work/01249/gda/stampede2/rpmtest
