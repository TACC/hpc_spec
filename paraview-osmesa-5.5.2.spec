Summary:  ParaView 5.5.2 OSMESA local binary install
...
Source:    %{pkg_base_name}-%{pkg_version}-1.tar.gz
...
%setup -n %{pkg_base_name}-%{pkg_version}/pv-osmesa
...
prepend_path("PYTHONPATH",        pathJoin(paraview_dir, "lib", "paraview-5.5", "site-packages"))
prepend_path("PYTHONPATH",        pathJoin(paraview_dir, "lib", "paraview-5.5", "site-packages", "vtk"))

prepend_path("MODULEPATH",        "%{MODULE_PREFIX}/paraview5.5/modulefiles")
