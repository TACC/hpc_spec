# $Id: launcher.spec,v 1.1 2020/2/14
# Si Liu
...
Group: Applications
%description package
TACC Parametric Job Launcher (GPU version)  is a simple utility for submitting multiple serial applications simultaneously.
...
whatis ("Name: TACC Parametric Job Launcher (GPU version) ")
...
local launcher_dir="/opt/apps/launcher_gpu/1.1"
local launcher_plugin_dir="/opt/apps/launcher_gpu/1.1/plugins"
setenv("TACC_LAUNCHER_GPU_DIR", launcher_dir)
