#
# Kent Milfeld  rpmbuild -bb htop-3.1.0.spec 2>&1 | tee htop-2.1.0_r1_a.log

# r=/admin/build/admin/rpms/ls6/RPMS/x86_64
# rpm -hiv --relocate /tmprpm=/opt/apps  $r/tacc-htop-package-3.1.0-1.el8.x86_64.rpm
# rpm -hiv --relocate /tmpmod=/opt/apps  $r/tacc-htop-modulefile-3.1.0-1.el8.x86_64.rpm
