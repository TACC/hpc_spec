...
* Wed Jun  7 2017 alarrosa@suse.com
...
* Mon Sep  5 2016 badshah400@gmail.com
...
* Mon Nov  2 2015 zaitor@opensuse.org
...
* Tue Jul  8 2014 fcrozat@suse.com
...
* Mon Jul  8 2013 sbrabec@suse.cz
...
* Tue Nov  6 2012 dimstar@opensuse.org
...
* Fri Oct 12 2012 dimstar@opensuse.org
...
* Sun Apr 29 2012 dimstar@opensuse.org
...
* Sat Apr 21 2012 jeffm@suse.com
...
* Tue Sep  7 2010 vuntz@opensuse.org
...
- Add a build_xcb_backend define to easily enable the build of the
  ...
  disabled by default.
* Mon Sep  6 2010 vuntz@opensuse.org
...
* Mon Oct  5 2009 vuntz@opensuse.org
...
- Explicitly pass --enable-pdf to configure because we require PDF
  support.
* Sat Aug  1 2009 captain.magnus@opensuse.org
- Fix packaging bug (Use %%{_libdir}/cairo/*.so.* instead of
  %%dir %%{_libdir}/cairo/*.so.*)
* Fri Jul  3 2009 captain.magnus@opensuse.org
...
- use Obsoletes: -XXbit only for ppc64 to help solver during distupgrade
  (bnc#437293)
* Mon Dec  8 2008 mboman@suse.de
- Update to version 1.8.4:
  + Many API changes, fixes and other updates. See NEWS for full details
* Tue Nov 11 2008 ro@suse.de
- SLE-11 uses PPC64 instead of PPC, adapt baselibs.conf
* Tue Nov  4 2008 maw@suse.de
- Disable the glitz backend (bnc#429280).
* Mon Nov  3 2008 vuntz@novell.com
...
* Wed Jul  4 2007 sbrabec@suse.cz
...
* Tue Nov  1 2005 sbrabec@suse.cz
- Updated to version 1.0.2.
* Tue Oct  4 2005 sbrabec@suse.cz
- Enabled ps and pdf backends (#120049).
* Fri Sep  9 2005 sbrabec@suse.cz
- Re-enabled glitz backend (#116075).
* Fri Sep  2 2005 matz@suse.de
- Fix last change.
* Fri Sep  2 2005 gekker@suse.de
- Remove Requires.private from the cairo.pc file as it causes
  build failures in gcc.
* Thu Sep  1 2005 gekker@suse.de
