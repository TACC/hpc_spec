...
Vendor: https://code.google.com/p/blis/
...
%description
RvdG BLAS-like Library Instantiation Software
...
####
#### IMPORTANT the knl option is not yet supported in the 0.2.1 release
####
./configure -p $RPM_BUILD_ROOT/%{INSTALL_DIR} knl
...
%changelog
* Thu Jan 12 2017 eijkhout <eijkhout@tacc.utexas.edu>
- release 1: initial release on KNL
