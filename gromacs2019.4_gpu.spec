...
%define pkg_base_name gromacs_gpu
...
export TACC_CUDA_DIR=/opt/apps/cuda/10.1/
...
-DCMAKE_C_FLAGS="-std=gnu99 -O3 -mkl=sequential  -g " \
-DCMAKE_CXX_FLAGS="-std=c++11 -O3 -mkl=sequential  -g " \
...
cd src/gromacs && /opt/intel/compilers_and_libraries_2019.5.281/linux/mpi/intel64/bin/mpicxx  -DGMX_DOUBLE=0 -DHAVE_CONFIG_H -DUSE_STD_INTTYPES_H -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/g_gpu_parallel/src -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/lmfit -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/thread_mpi/include -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/tng_io/include -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/g_gpu_parallel/tng/include  -O1 -mkl=sequential -g -std=c++11  -DNDEBUG -ip -funroll-all-loops -alias-const -ansi-alias -no-prec-div -fimf-domain-exclusion=14 -qoverride-limits  -qopenmp -o CMakeFiles/libgromacs.dir/pulling/pullutil.cpp.o -c /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/gromacs/pulling/pullutil.cpp
...
In addition, TACC provides GPU enabled version of mdrun with the suffix of _gpu (you must load cuda/10.1).
