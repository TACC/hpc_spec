...
# ./build_rpm.sh -l --intel=19 --impi=19_0 visit-3.1.2.spec
#
# After the build to deploy this package type the following :
# cd ../RPMS/x86_64
# rpm -i --relocate /tmprpm=/opt/apps tacc-visit-intel19-impi19_0-package-3.1.2-0.el7.centos.x86_64.rpm 
# rpm -i --relocate /tmpmod=/opt/apps tacc-visit-intel19-impi19_0-modulefile-3.1.2-0.el7.centos.x86_64.rpm
# To remove the packages type the following:
# rpm -e tacc-visit-intel19-impi19_0-package-3.1.2-0.el7.centos.x86_64 tacc-visit-intel19-impi19_0-modulefile-3.1.2-0.el7.centos.x86_64
