# Joe Garcia
# 2019-08-27
# copied over itac spec file from stampede2 and made changes here
#
...
local itac_full   = pathJoin( "intel", "itac", "%{lib_version}" )
