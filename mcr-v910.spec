...
whatis("Name: MCR")
whatis("Version: v9.10")
whatis("Category: library, mathematics")
whatis("Keywords: Library, Mathematics, Tools")
whatis("URL: http://www.mathworks.com/")
whatis("Description: Matlab v9.10 Compiler Runtime from MathWorks")

append_path("PATH", "/scratch/tacc/apps/mcr/9.10/bin")
append_path("LD_LIBRARY_PATH", "/scratch/tacc/apps/mcr/9.10/runtime/glnxa64")
append_path("LD_LIBRARY_PATH", "/scratch/tacc/apps/mcr/9.10/sys/os/glnxa64")
append_path("LD_LIBRARY_PATH", "/scratch/tacc/apps/mcr/9.10/sys/java/jre/glnxa64/jre/lib/amd64/server")
append_path("LD_LIBRARY_PATH", "/scratch/tacc/apps/mcr/9.10/sys/java/jre/glnxa64/jre/lib/amd64")

setenv ("TACC_MCR_DIR", "/scratch/tacc/apps/mcr/9.10")
