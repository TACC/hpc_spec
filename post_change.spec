...
#------------------------
  ...
  touch $RPM_BUILD_ROOT/%{INSTALL_DIR}/bin/test  
...
echo "CHANGING: " ${POST_INSTALL_PREFIX}/%{INSTALL_SUFFIX}/bin/test
echo ${POST_INSTALL_PREFIX}/%{INSTALL_SUFFIX} >> ${POST_INSTALL_PREFIX}/%{INSTALL_SUFFIX}/bin/test
