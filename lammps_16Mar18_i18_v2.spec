...
#
# rpmbuild -bb --define 'is_intel18 1' --define 'is_impi 1' --define 'mpiV 18_2' lammps_16Mar18_i18_v2.spec | tee log_lammps_16Mar18
#
...
EOF
  ...
  echo Making lammps binary without intel
  make -j 10 stampede \
