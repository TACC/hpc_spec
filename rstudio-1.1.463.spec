...
wget "http://download2.rstudio.org/rstudio-server-rhel-1.1.463-x86_64.rpm"
...
wget https://download-ib01.fedoraproject.org/pub/epel/testing/7/x86_64/Packages/r/R-core-3.6.1-2.el7.x86_64.rpm

# we also need libicu
#get "http://mirror.centos.org/centos/7/os/x86_64/Packages/libicu-50.1.2-15.el7.x86_64.rpm"
wget http://mirror.centos.org/centos/7/os/x86_64/Packages/libicu-50.2-3.el7.x86_64.rpm

rpm2cpio rstudio-server-rhel-1.1.463-x86_64.rpm | cpio -idmv
rpm2cpio R-core-3.6.1-2.el7.x86_64.rpm | cpio -idmv
rpm2cpio libicu-50.2-3.el7.x86_64.rpm | cpio -idmv
...
cp ./usr/lib64/R/lib/libRrefblas.so %{INSTALL_DIR}/lib/
