...
export PATH=${gcc_install}/x86_64-pc-linux-gnu/bin:${PATH}
export LD_LIBRARY_PATH=${gcc_install}/lib:${LD_LIBRARY_PATH}
export LD_LIBRARY_PATH=${gcc_install}/x86_64-pc-linux-gnu/lib:${LD_LIBRARY_PATH}
...
make BOOT_CFLAGS='-O2 -fPIC' bootstrap -j ${ncores}
make install -j ${ncores}
