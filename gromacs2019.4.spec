...
-DCMAKE_C_FLAGS="-std=gnu99 -O3 -xCORE-AVX512 -g " \
-DCMAKE_CXX_FLAGS="-std=c++11 -O3 -xCORE-AVX512 -g " \
-DGMX_DEFAULT_SUFFIX=ON \
-DGMX_BUILD_SHARED_EXE=OFF \
-DGMX_EXTERNAL_BOOST=OFF 

cd src/gromacs && /opt/intel/compilers_and_libraries_2019.5.281/linux/bin/intel64/icpc  -DGMX_DOUBLE=0 -DHAVE_CONFIG_H -DUSE_STD_INTTYPES_H -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/g_single_serial/src -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/lmfit -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/thread_mpi/include -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/tng_io/include -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/g_single_serial/tng/include  -O1 -xCORE-AVX512 -qopt-zmm-usage=high   -mkl=sequential -g -std=c++11  -wd3180 -DNDEBUG -ip -funroll-all-loops -alias-const -ansi-alias -no-prec-div -fimf-domain-exclusion=14 -qoverride-limits     -o CMakeFiles/libgromacs.dir/pulling/pullutil.cpp.o -c /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/gromacs/pulling/pullutil.cpp
...
-DCMAKE_EXE_LINKER_FLAGS=" -mkl=sequential" \
-DGMX_OPENMP_MAX_THREADS=256 \
-DCMAKE_C_FLAGS="-std=gnu99 -O3 -xCORE-AVX512 -mkl=sequential -g " \
-DCMAKE_CXX_FLAGS="-std=c++11 -O3 -xCORE-AVX512 -mkl=sequential -g " \
-DGMX_DEFAULT_SUFFIX=OFF \
-DGMX_EXTERNAL_BOOST=OFF \
-DGMX_BUILD_SHARED_EXE=OFF \
-DGMX_BINARY_SUFFIX=_mpi

cd src/gromacs && /opt/intel/compilers_and_libraries_2019.5.281/linux/mpi/intel64/bin/mpicxx  -DGMX_DOUBLE=0 -DHAVE_CONFIG_H -DUSE_STD_INTTYPES_H -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/g_single_parallel/src -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/lmfit -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/thread_mpi/include -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/tng_io/include -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/g_single_parallel/tng/include  -O1 -xCORE-AVX512 -mkl=sequential -g -std=c++11 -DNDEBUG   -qopenmp -o CMakeFiles/libgromacs.dir/pulling/pullutil.cpp.o -c /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/gromacs/pulling/pullutil.cpp
...
cd src/gromacs && /opt/intel/compilers_and_libraries_2019.5.281/linux/mpi/intel64/bin/mpicxx  -DGMX_DOUBLE=1 -DHAVE_CONFIG_H -DUSE_STD_INTTYPES_H -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/g_double_parallel/src -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src -I/admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/lmfit -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/thread_mpi/include -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/external/tng_io/include -isystem /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/g_double_parallel/tng/include  -O1 -xCORE-AVX512 -mkl=sequential -g -std=c++11  -DNDEBUG   -qopenmp -o CMakeFiles/libgromacs.dir/pulling/pullutil.cpp.o -c /admin/build/admin/rpms/frontera/BUILD/gromacs-2019.4/src/gromacs/pulling/pullutil.cpp
