# $Id: launcher.spec,v 3.7 2020/07/13 
# Si Liu
...
For more information about launcher, please visit
https://github.com/TACC/launcher

More examples and demos can be found under the
${TACC_LAUNCHER_DIR}/extra directory.
...
local launcher_dir="/opt/apps/launcher/launcher-3.7"
local launcher_plugin_dir="/opt/apps/launcher/launcher-3.7/plugins"
