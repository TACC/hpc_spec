...
# We are not supporting <= RHEL 6
%global build6x 0

# We are not supporting fedora
...
Source0: tacc-openssh-hpn-%{version}.tar.gz
#Source1: http://www.jmknoble.net/software/x11-ssh-askpass/x11-ssh-askpass-%{aversion}.tar.gz
License: BSD
Group: Applications/Internet
BuildRoot: %{_tmppath}/%{name}-%{version}-buildroot
Packager:  TACC - cweir@tacc.utexas.edu
Obsoletes: ssh
...
%if ! %{no_x11_askpass}
%setup -q -a 1 -n tacc-openssh-hpn-%{ver}
%else
%setup -q -n tacc-openssh-hpn-%{ver}
%endif
...
%changelog
* Mon Nov 09 2020 Collin Weir <cweir@tacc.utexas.edu>
- Updated tacc specific build flags for compilation
