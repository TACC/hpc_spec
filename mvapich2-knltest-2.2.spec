#
# $Id: mvapich2-knltest-2.2 2017-01-18 15:29:50Z carlos $
#
...
Name:    mvapich2-knltest
Version: 2.2
Release: 2%{?dist}
License: freely distributable
Group:   Development/Libraries
Source:  mvapich2-knltest-%{version}.tar.gz
...
%define patch1 mvapich2-2.2-knl-startup-improvements-v2.patch
%define mpi_fam mvapich2
%define mpi_fam_ver mvapich2-knltest_2_2
...
%setup -n mvapich2-knltest-%{version}  mvapich2-knltest-%{version}
...
# crf 2017.01.18 Patch for KNL startup optimization
...
puts stderr " "
puts stderr "Mvapich2 2.2 with KNL optimizations for inital testing"
puts stderr " " 
