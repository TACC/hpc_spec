# $Id: launcher.spec, v3.9 08/01/2021
# Si Liu
...
${TACC_LAUNCHER_DIR}/extras directory.
...
local launcher_dir="/opt/apps/launcher/3.8"
local launcher_plugin_dir="/opt/apps/launcher/3.8/plugins"
