...
Summary: Zoltan, piggybacking on the PETSc install

# Give the package a base name
%define pkg_base_name zoltan
%define MODULE_VAR    ZOLTAN
...
URL:       http://graal.ens-lyon.fr/ZOLTAN/
...
%package %{MODULEFILE}
Summary: Zoltan local binary install
Group: System Environment/Base
%description modulefile
This is the long description for the modulefile RPM...

%description
Zoltan is a solver library for distributed sparse linear system.
...
local             zoltan_arch =    "${architecture}"
local             zoltan_dir  =     "${TACC_PETSC_DIR}"
...
#%Module1.0#################################################
##
## version file for Zoltan %version
##
...
- release 3: intel/18.0.2
* Wed May 09 2018 eijkhout <eijkhout@tacc.utexas.edu>
