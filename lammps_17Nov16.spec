...
##rpmbuild -bb --define 'is_intel17 1' --define 'is_impi 1' lammps_17Nov16.spec | tee log_lammps_17Nov16.0
##rpmbuild -bb --define 'is_intel17 1' --define 'is_impi 1' lammps4.spec | tee lammps.log.4
...
if [[ $liblist =~ "quip" ]]; then
 cd lib/quip
   ...
   #ml netcdf
    ...
    sed -i "s/-vec-report0 -unroll -xP/$KNL_OPTS -diag-disable=7712/" arch/Makefile.$QUIP_ARCH
    sed -i "s/COPTIM = -O3/COPTIM = -O3 $KNL_OPTS -diag-disable=7712/" arch/Makefile.$QUIP_ARCH
 ...
 cd lib/qmmm
   ...
   #make -f Makefile.gfortran
    make -f Makefile.ifort MPICXX=mpicxx \
            ...
            MPICXXFLAGS=" $KNL_OPTS -DOMPI_SKIP_MPICXX=1 -O2 -Wall -g -fPIC -I../../src -I$QETOPDIR/COUPLE/include"
...
## cd lib/reax
##    echo "Working on reax"
##    make -j 4 -f Makefile.ifort F90="ifort $KNL_OPTS " \
...
These USER modules were not built: kokkos, molfile, python, quip, reax, smd vtk 
