...
#------------------------
  ...
  # download caffe
  wget https://github.com/intel/caffe/archive/1.0.3.tar.gz
  ...
  # download libraries
  git clone -b caffe-v1.0.3 --single-branch https://github.com/zhaozhang/caffe-stampede2.git
  ...
  CC=icc CXX=icpc ./configure --prefix=/admin/build/rpms/BUILD/caffe-1.0.3/caffe-stampede2/libraries/protocol-buffer-build
  make
  make install
  export PATH=/admin/build/rpms/BUILD/caffe-1.0.3/caffe-stampede2/libraries/protocol-buffer-build/bin:$PATH
  popd
  popd
  popd
