...
local base         = "/home1/apps/intel/16.0.3"
...
prepend_path( "LIBRARY_PATH" ,        pathJoin( installDir , "tbb/lib/intel64/gcc4.4" ) )
prepend_path( "LIBRARY_PATH" ,        pathJoin( installDir , "daal/lib/intel64_lin" ) )
prepend_path( "LIBRARY_PATH" ,        pathJoin( installDir , "tbb/lib/intel64_lin/gcc4.4" ) )
...
prepend_path( "LD_LIBRARY_PATH" ,     pathJoin( installDir , "tbb/lib/intel64/gcc4.4" ) )
...
prepend_path( "LD_LIBRARY_PATH" ,     pathJoin( installDir , "tbb/lib/intel64_lin/gcc4.4" ) )
