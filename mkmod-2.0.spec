...
# rpm -hiv --relocate /tmprpm=/opt/apps    $r/tacc-mkmod-package-2.0-1.el7.x86_64.rpm
# rpm -hiv --relocate /tmpmod=/opt/apps $r/tacc-mkmod-modulefile-2.0-1.el7.x86_64.rpm
#
