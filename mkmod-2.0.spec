#
# 2019-06-29
# rpmbuild -bb mkmod-2.0.spec 2>&1 | tee mkmod-2.0.log

# r=/admin/build/admin/rpms/ls6/RPMS/x86_64
# rpm -hiv --relocate /tmprpm=/opt/apps $r/tacc-mkmod-package-2.0-1.el8.x86_64.rpm
# rpm -hiv --relocate /tmpmod=/opt/apps $r/tacc-mkmod-modulefile-2.0-1.el8.x86_64.rpm
#
