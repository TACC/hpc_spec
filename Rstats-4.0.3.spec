...
R_VERSION='R-4.0.3'
cp /admin/build/admin/rpms/frontera/SOURCES/Rstats/${R_VERSION}-custom.tar.gz ${R_VERSION}.tar.gz
...
cp /admin/build/admin/rpms/frontera/SOURCES/Rstats/packagestats/packagestats_0.0.5.0000.tar.gz packagestats.tar.gz
R CMD INSTALL --no-test-load packagestats.tar.gz

mkdir %{INSTALL_DIR}/etc
cp /admin/build/admin/rpms/frontera/SOURCES/Rstats/packagestats/Rprofile.site %{INSTALL_DIR}/etc/
