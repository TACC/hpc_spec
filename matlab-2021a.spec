...
whatis("Name: MATLAB")
whatis("Version: 2021a")
whatis("Category: library, mathematics")
whatis("Keywords: Library, Mathematics, Tools")
whatis("URL: http://www.mathworks.com/")
whatis("Description: Matlab 2021a from MathWorks")

append_path("PATH", "/scratch/tacc/apps/matlab/2021a/bin")

append_path("LD_LIBRARY_PATH", "/scratch/tacc/apps/matlab/2021a/bin/glnxa64")
append_path("LD_LIBRARY_PATH", "/scratch/tacc/apps/matlab/2021a/runtime/glnxa64")
append_path("LD_LIBRARY_PATH", "/scratch/tacc/apps/matlab/2021a/sys/java/jre/glnxa64/jre/lib/amd64/server/")

setenv ("TACC_MATLAB_DIR", "/scratch/tacc/apps/matlab/2021a")
