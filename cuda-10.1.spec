...
%define patch_version 243
%define driver_version 418.87.00
...
local cuda_dir="/usr/local/cuda-10.1"
...
prepend_path("MODULEPATH"     ,pathJoin("/opt/apps","%{cuda_fam_ver}","modulefiles"))
