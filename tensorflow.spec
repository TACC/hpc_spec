...
%define bazel_six_major_version   0
...
%define bazel_six_version   %{bazel_six_major_version}.%{bazel_six_minor_version}.%{bazel_six_micro_version}
...
%else
  ...
  %define python_pkg_date   December 11, 2017 
%endif
...
echo "bazel_six_version    %{bazel_six_version}"
...
#------------------------
  ...
  rm -rf %{_builddir}/bazel-%{bazel_six_version}
...
%{pip_name} install --prefix=%{INSTALL_DIR} tensorboard==%{tensorboard_version} ## Changed to just tensorboard with verstion 1.6.0
