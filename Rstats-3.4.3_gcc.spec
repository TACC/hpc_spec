...
#wget -q -N 'http://cran.r-project.org/src/base/R-3/R-3.4.3.tar.gz'
#tar zxf R-3.4.3.tar.gz
#cd R-3.4.3

# Use custom edited build

cp /admin/build/SOURCES/R-3.4.0-custom.tar.gz .
...
./configure --prefix=%{INSTALL_DIR} \
  ...
  CC=/opt/apps/gcc/4.9.3/bin/gcc CXX=/opt/apps/gcc/4.9.3/bin/g++ \
  F77=/opt/apps/gcc/4.9.3/bin/gfortran FC=/opt/apps/gcc/4.9.3/bin/gfortran \
  #LD=xild AR=xiar \
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:%{INSTALL_DIR}/lib64:%{INSTALL_DIR}/lib
