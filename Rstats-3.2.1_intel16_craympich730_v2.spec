...
# Custom tarball contains hardcoded fixes, primarly with Intel compilers and fork.c
cp /admin/rpms/SOURCES/R-3.2.1-custom.tar.gz R-3.2.1.tar.gz  #Make a copy to keep from accidently messing up the custom tarbell
