#
# rpmbuild -bb --define 'is_intel19 1' --define 'is_impi 1' --define 'mpiV 19_0' gromacs-2021.3.spec 2>&1 | tee gromacs2021.3.log
...
-DCMAKE_C_FLAGS="-O3 -g -march=core-avx2" \
-DCMAKE_CXX_FLAGS="-O3 -g -march=core-avx2" \
-DGMX_EXTERNAL_BOOST=OFF \
-DGMX_BUILD_SHARED_EXE=OFF \
-DGMX_DEFAULT_SUFFIX=OFF \
-DGMX_BINARY_SUFFIX=_serial \
-DGMX_LIBS_SUFFIX=_serial
...
-DGMX_BUILD_SHARED_EXE=OFF \
-DGMX_DEFAULT_SUFFIX=OFF \
-DGMX_BINARY_SUFFIX=_tmpi \
-DGMX_LIBS_SUFFIX=_tmpi
...
The parallel component of gromacs is the molecular dynamics engine, mdrun.
...
mdrun_mpi is the parallel version fo mdrun using MPI
mdrun_mpi_d is a double-precision version of mdrun_mpi
mdrun_tmpi is the parallel version of mdrun which supports the gromacs built-in thread-MPI (only for single-node jobs)
mdrun_serial is the serial version fo mdrun

gmx_mpi/gmx_tmpi is the MPI/thread-MPI version of gmx which is also included in this module
