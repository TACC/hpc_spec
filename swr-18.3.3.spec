...
LD_LIBRARY_PATH=$SWR_LD_LIBRARY_PATH:$LD_LIBRARY_PATH KNOB_MAX_WORKER_THREADS=$MAX_WORKER_THREADS XLIB_SKIP_ARGB_VISUALS=1 GALLIUM_DRIVER=llvmpipe $*
EOF
...
LD_LIBRARY_PATH=$SWR_LD_LIBRARY_PATH:$LD_LIBRARY_PATH KNOB_MAX_WORKER_THREADS=$MAX_WORKER_THREADS XLIB_SKIP_ARGB_VISUALS=1 GALLIUM_DRIVER=swr $*
EOF
