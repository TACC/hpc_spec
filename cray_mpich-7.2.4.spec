...
%if "%{comp_fam}" == "intel"
local comp_dir  = "mpich2-intel/14.0"
local full_path = pathJoin( mpt_path, comp_dir ) 
...
prepend_path( "MANPATH", pathJoin( mpt_path, "man/mpich2" ) )
...
setenv( "PE_MPICH_VOLATILE_PKGCONFIG_PATH", pathJoin( mpt_path, "mpich2-@PRGENV@@PE_MPICH_DIR_DEFAULT64@/@PE_MPICH_GENCOMPS@/lib/pkgconfig" ) )
