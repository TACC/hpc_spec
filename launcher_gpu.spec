...
%define pkg_base_name launcher_gpu
%define MODULE_VAR LAUNCHER_GPU
...
%package %{PACKAGE}
Summary: Launcher_GPU package RPM
Group: Applications
%description package
TACC Parametric Job Launcher_GPU is a simple utility for submitting multiple serial applications simultaneously.
...
Job Launcher_GPU which is a simple utility for submitting multiple
serial applications simultaneously.

For more information on using the Launcher_GPU, please consult
...
whatis ("Name: TACC Parametric Job Launcher_GPU")
...
setenv("TACC_LAUNCHER_DIR", "/opt/apps/launcher_gpu/1.0" )
setenv("LAUNCHER_DIR",      "/opt/apps/launcher_gpu/1.0" )
setenv("LAUNCHER_PLUGIN_DIR", "/opt/apps/launcher_gpu/1.0/plugins")
