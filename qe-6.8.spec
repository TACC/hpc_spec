...
%define HOME1 /scratch/tacc/apps
...
#cp ../configure-elpa-mavx2-omp.sh .

#./configure-elpa-mavx2-omp.sh

#make -j ; make install

#cd ../elpa/include
#mv elpa_openmp-2021.05.002 elpa

#cd ../../

#wget https://github.com/QEF/q-e/archive/refs/tags/qe-6.8.tar.gz
#tar zxvf qe-6.8.tar.gz
#cd q-e-qe-6.8

#cp ../configure-qe-mavx2-omp.sh .

#./configure-qe-mavx2-omp.sh
...
cp -r ./q-e-qe-6.8/* $RPM_BUILD_ROOT/%{INSTALL_DIR}/
