...
R_VERSION='R-3.5.1'
cp /admin/build/admin/rpms/stampede2/SOURCES/${R_VERSION}-custom.tar.gz ${R_VERSION}.tar.gz
...
cp /admin/build/admin/rpms/stampede2/SOURCES/packagestats/packagestats_0.0.5.0000.tar.gz packagestats.tar.gz
R CMD INSTALL packagestats.tar.gz

mkdir %{INSTALL_DIR}/etc
cp /admin/build/admin/rpms/stampede2/SOURCES/packagestats/Rprofile.site %{INSTALL_DIR}/etc/
