...
You can run the command "sanitycheck" to examine your current environment settings on Longhorn.
...
local sanitypath = "/opt/apps/sanitytool/1.5"
append_path("PATH",sanitypath)
setenv("TACC_SANITYTOOL_DIR", "/opt/apps/sanitytool/1.5")
