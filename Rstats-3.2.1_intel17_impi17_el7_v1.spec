...
# Won't default of intel17 and impi17
...
prepend_path("PATH","/opt/apps/gcc/5.4.0/bin")
prepend_path("LD_LIBRARY_PATH","/opt/apps/gcc/5.4.0/lib")
prepend_path("LD_LIBRARY_PATH","/opt/apps/gcc/5.4.0/lib64")
