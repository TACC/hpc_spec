...
%define pkg_base_name scons
%define MODULE_VAR    SCONS
...
the main SCons directory, the binaries, and libraries respectively.
...
whatis("Description: software construction tool")
whatis("URL: http://scons.org")

-- Export environmental variables
local scons_dir="%{INSTALL_DIR}"
local scons_bin=pathJoin(scons_dir,"bin")
local scons_lib=pathJoin(scons_dir,"lib")
setenv("TACC_SCONS_DIR",scons_dir)
setenv("TACC_SCONS_BIN",scons_bin)
setenv("TACC_SCONS_LIB",scons_lib)

-- Prepend the scons directories to the adequate PATH variables
prepend_path("PATH",scons_bin)
prepend_path("LD_LIBRARY_PATH",scons_lib)
