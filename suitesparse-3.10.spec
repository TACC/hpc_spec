...
Summary: Suitesparse, piggybacking on the PETSc install
...
%description
Suitesparse is a solver library for distributed sparse linear system.
...
local             suitesparse_arch =    "${architecture}"
local             suitesparse_dir  =     "${TACC_PETSC_DIR}"
...
%changelog
* Mon Nov 05 2018 eijkhout <eijkhout@tacc.utexas.edu>
