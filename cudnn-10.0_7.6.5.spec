...
#------------------------
  ...
  #========================================
  rm -rf cuda/
  tar xvfz %{_sourcedir}/cudnn-%{cuda_version}-linux-ppc64le-v%{major_version}.%{minor_version}.%{patch_version}*tgz
  cd cuda
...
prepend_path(    "LD_LIBRARY_PATH",     pathJoin(base_dir, "targets/ppc64le-linux/lib"))
setenv( "TACC_%{MODULE_VAR}_DIR",                base_dir)
setenv( "TACC_%{MODULE_VAR}_INC",       pathJoin(base_dir, "targets/ppc64le-linux/include"))
setenv( "TACC_%{MODULE_VAR}_LIB",       pathJoin(base_dir, "targets/ppc64le-linux/lib"))
