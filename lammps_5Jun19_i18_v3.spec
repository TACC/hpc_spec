...
%if %{?BUILD_PACKAGE}
  ...
  rm -rf lib/qmmm lib/reax lib/quip
  ...
  rm -rf                 $RPM_BUILD_ROOT/%{INSTALL_DIR}/lib/scafacos/scafacos-src  
  rm -rf                 $RPM_BUILD_ROOT/%{INSTALL_DIR}/lib/atc
