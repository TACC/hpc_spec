...
help(
[[
This version of Amber was built on %(date +'%B %d, %Y'). The TACC Amber installation
includes the parallel binaries with the '.MPI' suffix and GPU-enabled binaries
with 'cuda' in the name. For example, see:
