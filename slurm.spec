...
%define pkg_base_name slurm
%define MODULE_VAR    SLURM
...
%description
This is specifically an rpm for the slurm modulefile
used on LS5.
...
local help_msg=[[
Slurm is an open-source workload manager designed for Linux clusters of all
