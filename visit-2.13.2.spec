...
sed -e "s:VISITINSTALLDIR:%{whereitallgoes}:"  %{whereitallgoes}/current/.visit/hosts/dummy.xml > %{whereitallgoes}/current/.visit/hosts/host_tacc_lonestar.xml 
chmod a+r %{whereitallgoes}/current/.visit/hosts/host_tacc_lonestar.xml
%post %{MODULEFILE}
