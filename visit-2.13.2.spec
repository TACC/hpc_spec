...
# ./build_rpm.sh -l --intel=18 --impi=18_0 visit-2.13.2.spec
#
# After the build to deploy this package type the following :
# cd ../RPMS/x86_64
# rpm -i --relocate /tmprpm=/opt/apps tacc-visit-intel18-impi18_0-package-2.13.2-0.el7.centos.x86_64.rpm 
# rpm -i --relocate /tmpmod=/opt/apps tacc-visit-intel18-impi18_0-modulefile-2.13.2-0.el7.centos.x86_64.rpm
# To remove the packages type the following:
# rpm -e tacc-visit-intel18-impi18_0-package-2.13.2-0.el7.centos.x86_64 tacc-visit-intel18-impi18_0-modulefile-2.13.2-0.el7.centos.x86_64
...
# VisIt that we are packaging. For Example VisIt-2.12.2 would have major_version
# set to 2, minor_version set to 13, and micro_version set to 2. 
...
sed -e "s:VISITINSTALLDIR:%{whereitallgoes}:"  %{whereitallgoes}/current/.visit/hosts/dummy.xml > %{whereitallgoes}/current/.visit/hosts/host_tacc_frontera.xml 
chmod a+r %{whereitallgoes}/current/.visit/hosts/host_tacc_frontera.xml
%post %{MODULEFILE}
