...
#  export CPPFLAGS="-O3 -xCORE-AVX2 -axMIC-AVX512,CORE-AVX512 -fp-model precise"
 %if "%is_intel" == "1" 
  ...
  export CFLAGS="-O3 -xCORE-AVX2 -axCORE-AVX512 -fp-model precise"
  export CPPFLAGS="-O3 -xCORE-AVX2 -axCORE-AVX512 -fp-model precise"
  export LDFLAGS="-xCORE-AVX2 -axCORE-AVX512"
%endif
...
%if "%is_gcc" == "1" 
  ...
  export CPPFLAGS="-O3 -mavx2"
  export LDFLAGS="-mavx2"
%endif
