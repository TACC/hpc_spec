...
#  export CPPFLAGS="-O3 -xAVX -axCORE-AVX2 -fp-model precise"
 %if "%is_intel" == "1" 
  ...
  export CPPFLAGS="-xCORE-AVX2 -axMIC-AVX512,CORE-AVX512" 
...
%if "%is_gcc" == "1" 
  export CC=`which gcc`
  export CXX=`which g++`
  export CFLAGS="-O3 -march=broadwell -mtune=knl"
  export CPPFLAGS="-O3 -march=broadwell -mtune=knl"
  export LDFLAGS="-march=broadwell -mtune=knl"
%endif
