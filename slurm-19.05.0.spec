...
%global _with_pmix --with-pmix=/opt/apps/pmix/3.1.2
%global _with_ucx  --with-ucx=/opt/apps/ucx/1.5.1
%global _with_hwloc --with-hwloc=/opt/apps/hwloc/1.11.12
%global _with_numa 1
%global _with_lua 1
...
%bcond_with numa
%bcond_with x11
%bcond_with pmix /opt/apps/pmix/3.1.2
