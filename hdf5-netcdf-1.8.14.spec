...
#
#
%define hdf5_pkg_version   1.8.14
%define ncdf_pkg_version   4.3.2
%define ncdf_cxx_version   4.2
%define ncdf_cxx4_version  4.2.1
%define ncdf_ftn_version   4.4.1
...
NETCDF 4.2.1.1 uses the hdf5 libraries to support the NETCDF 4 file format 
