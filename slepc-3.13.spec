...
# same as in petsc
export dynamic="debug single i64 i64debug complexi64 complexi64debug uni unidebug complex complexdebug"
...
%changelog
* Sat May 09 2020 eijkhout <eijkhout@tacc.utexas.edu>
