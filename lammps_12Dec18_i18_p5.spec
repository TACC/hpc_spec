...
#
# rpmbuild -bb --define 'is_intel18 1' --define 'is_impi 1' --define 'mpiV 18_2' lammps_12Dec18_i18_p5.spec | tee log_lammps_12Dec18
#
...
EOF
  ...
  rm -r /opt/apps/intel18/impi18_0/lammps/%{major_version}
