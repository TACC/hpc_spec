...
# version 3.10 corresponds to the petsc version
# we inherit from
#
# based on Bar.spec
# W. Cyrus Proctor
...
%changelog
* Thu Nov 07 2018 eijkhout <eijkhout@tacc.utexas.edu>
- release 4: fix knightslanding -> skylake
* Tue Aug 14 2018 eijkhout <eijkhout@tacc.utexas.edu>
- release 3: intel18.0.2
