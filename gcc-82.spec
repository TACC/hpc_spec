...
export mpfr_major=4  #3
export mpfr_minor=0  #1
#export mpfr_patch=4
export mpfr_patch=1  #6
...
make V=1 BOOT_CFLAGS='-O2' bootstrap -j ${ncores}
make install -j ${ncores}
