...
local gcc_base     = "/opt/apps/gcc/9.4.0"
...
--MANPATH=
-- /opt/intel/documentation_2020/en/debugger/gdb-ia/man
...
--IPPROOT=
-- /opt/intel/compilers_and_libraries_2020.1.217/linux/ipp
...
-- /opt/intel/compilers_and_libraries_2020.1.217/linux/pstl/include
...
--NLSPATH=
-- /opt/intel/compilers_and_libraries_2020.1.217/linux/compiler/lib/intel64/locale/%l_%t/%N
-- /opt/intel/compilers_and_libraries_2020.1.217/linux/mkl/lib/intel64_lin/locale/%l_%t/%N
-- /opt/intel/debugger_2020/gdb/intel64/share/locale/%l_%t/%N
...
--TBBROOT=
-- /opt/intel/compilers_and_libraries_2020.1.217/linux/tbb

setenv( "DAALROOT" ,          daalRoot )

--DAALROOT=
-- /opt/intel/compilers_and_libraries_2020.1.217/linux/daal

setenv( "PSTLROOT" ,          pstlRoot )

--PSTLROOT=
-- /opt/intel/compilers_and_libraries_2020.1.217/linux/pstl
