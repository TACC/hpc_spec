...
# ./build_rpm.sh intel-19.1.1.spec
# cd ../RPMS/x86_64
# rpm -qilp Bar-package-1.1-1.x86_64.rpm 
# rpm -hiv --relocate /tmprpm=/opt/apps Bar-package-1.1-1.x86_64.rpm
# rpm -hiv --relocate /tmpmod=/opt/apps Bar-modulefile-1.1-1.x86_64.rpm
...
Note: To provide C++ support for the Intel compiler, this module adds the
paths for the gcc/9.1.0 bin, lib, and lib64 directories to your environment.
...
prepend_path( "LIBRARY_PATH" ,        pathJoin( installDir , "ipp/lib/intel64_lin"                ) )
...
prepend_path( "LIBRARY_PATH" ,        pathJoin( installDir , "tbb/lib/intel64_lin/gcc4.8"         ) )
...
prepend_path( "LD_LIBRARY_PATH" ,        pathJoin( installDir , "ipp/lib/intel64_lin"                 ) )
...
prepend_path( "NLSPATH" ,     pathJoin( installDir , "compiler/lib/intel64_lin/locale/%l_%t/%N"             ) )
...
setenv( "TACC_INTEL_LIB" ,      pathJoin(installDir , "compiler/lib/intel64_lin" ) )
