...
--MKLROOT=
--/opt/intel/compilers_and_libraries_2020.0.166/linux/mkl
...
--INTEL_LICENSE_FILE=
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/licenses
-- /opt/intel/licenses
-- ${HOME}/intel/licenses

setenv( "IPPROOT" ,                   ippRoot )
--IPPROOT=
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/ipp
...
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/tbb/lib/intel64/gcc4.7
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/daal/lib/intel64_lin
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/daal/../tbb/lib/intel64_lin/gcc4.4
...
--CPATH=
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/ipp/include
...
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/pstl/include
...
--NLSPATH=
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/compiler/lib/intel64/locale/%l_%t/%N
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/mkl/lib/intel64_lin/locale/%l_%t/%N
...
--TBBROOT=
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/tbb

setenv( "DAALROOT" ,          daalRoot )

--DAALROOT=
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/daal

setenv( "PSTLROOT" ,          pstlRoot )

--PSTLROOT=
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/pstl

setenv("PKG_CONFIG_PATH",     pathJoin(mklRoot, "bin/pkgconfig") )

--PKG_CONFIG_PATH=
-- /opt/intel/compilers_and_libraries_2020.0.166/linux/mkl/bin/pkgconfig
