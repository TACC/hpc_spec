...
## rpmbuild -bb --define 'is_intel19 1'  pdtoolkit-3.25.1.spec 2>&1 | tee pdtoolkit-3.25.1_intel19_r1_a.log
## rpmbuild -bb --define 'is_gcc63 1'    pdtoolkit-3.25.1.spec 2>&1 | tee pdtoolkit-3.25.1_gcc63_r1.log
#
#  r=/admin/build/admin/rpms/frontera/RPMS/x86_64
#  rpm -hiv --nodeps $r/tacc-pdtoolkit-intel19-package-3.25.1-1.el7.x86_64.rpm
#  rpm -hiv --nodeps $r/tacc-pdtoolkit-intel19-modulefile-3.25.1-1.el7.x86_64.rpm
