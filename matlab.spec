...
prepend_path("PATH", "/opt/shared/matlab/2018b/bin")

append_path("LD_LIBRARY_PATH", "/opt/shared/matlab/2018b/bin/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/shared/matlab/2018b/runtime/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/shared/matlab/2018b/sys/java/jre/glnxa64/jre/lib/amd64/server/")

setenv ("TACC_MATLAB_DIR", "/opt/shared/matlab/2018b")
