...
%define INSTALL_DIR  /scratch/tacc/apps/%{pkg_base_name}/%{pkg_version}
...
whatis("Description: Matlab %{pkg_version} from MathWorks")

local matlab_dir           = "%{INSTALL_DIR}"

family("matlab")

setenv( "TACC_MATLAB_DIR",       matlab_dir)
append_path("PATH" ,             pathJoin(matlab_dir, "bin") )
append_path("LD_LIBRARY_PATH",   pathJoin(matlab_dir, "bin/glnxa64") )
append_path("LD_LIBRARY_PATH",   pathJoin(matlab_dir, "runtime/glnxa64") )
append_path("LD_LIBRARY_PATH",   pathJoin(matlab_dir, "sys/java/jre/glnxa64/jre/lib/amd64/server/") )
