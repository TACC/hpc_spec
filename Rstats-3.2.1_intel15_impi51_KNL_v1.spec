...
wget -N 'http://cran.r-project.org/src/base/R-3/R-3.2.1.tar.gz'
echo 'Goter'
...
./configure --prefix=%{INSTALL_DIR} \
  ...
  LD=xild AR=xiar \
  SHLIB_CFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  "\
  MAIN_FFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  "\
  SHLIB_FFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  "\
  MAIN_LDFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"\
  SHLIB_LDFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"\
  DYLIB_LDFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"\
  SHLIB_CXXLDFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost   -L${TACC_MKL_LIB} -lmkl_rt"\
  SHLIB_FCLDFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -shared -fPIC -openmp -mkl=parallel -O3 -xHost   -L${TACC_MKL_LIB} -lmkl_rt"\
  BLAS_LIBS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"\
  LAPACK_LIBS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"\
  CFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"\
  LDFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"\
  CPPFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"\
  FFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"\
  CXXFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"\
  FCFLAGS="-xCOMMON-AVX512 -axCORE-AVX2 -fPIC -openmp -mkl=parallel -O3 -xHost  -L${TACC_MKL_LIB} -lmkl_rt"
