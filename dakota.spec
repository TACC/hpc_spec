...
export BLASLIB="-Wl,-rpath,/opt/intel/compilers_and_libraries_2017.0.098/linux/compiler/lib/intel64 -L/opt/intel/compilers_and_libraries_2017.0.098/linux/compiler/lib/intel64 -Wl,-rpath,${MKLROOT}/lib/intel64 -L${MKLROOT}/lib/intel64 -lmkl_intel_lp64 -lmkl_core -lmkl_intel_thread -liomp5 -lpthread -lm -ldl"
