...
#
# rpmbuild -bb --define 'is_intel18 1' --define 'is_impi 1' --define 'mpiV 18_2' lammps_12Dec18_i18_v1.spec | tee log_lammps_12Dec18
#
...
%if %{?BUILD_PACKAGE}
  ...
  liblist="atc awpmd colvars compress h5md     linalg meam netcdf poems python quip smd voronoi"
...
%if %{?BUILD_PACKAGE}
  ...
  rm -rf lib/qmmm lib/reax lib/vtk lib/kim
...
The following packages were not installed:
  ...
  GPU, KIM, KOKKOS, LATTE, MESSAGE, MSCG, REAX, USER-SCAFACOS, USER-MOLFILE, USER-QMMM, USER-VTK
