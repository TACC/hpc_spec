...
#nccl-repo-rhel7-2.4.8-ga-cuda10.0-1-1.ppc64le.rpm
...
#------------------------
  ...
  #========================================
  rm -rf nccl_%{pkg_version}*+cuda%{cuda_version}_ppc64le
  tar xvf %{_sourcedir}/nccl_%{pkg_version}*+cuda%{cuda_version}_ppc64le.txz
  cd nccl_%{pkg_version}*+cuda%{cuda_version}_ppc64le
