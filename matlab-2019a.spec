# $Id: matlab.spec, v2019a, 2019/04/26 siliu $ 
...
append_path("PATH", "/opt/apps/matlab/2019a/bin")

append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2019a/bin/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2019a/runtime/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2019a/sys/java/jre/glnxa64/jre/lib/amd64/server")

setenv ("TACC_MATLAB_DIR", "/opt/apps/matlab/2019a")
