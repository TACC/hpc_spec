...
#
# rpmbuild -bb --define 'is_intel18 1' --define 'is_impi 1'  gpaw-1.5.1.spec | tee log_gpaw_1.5.1
# ./build_rpm.sh -i18 -j18_2 -l gpaw-1.5.1.spec
...
%define VERSION_VDW 0.3.2
%define VERSION_XC 4.3.0
%define VERSION_ASE 3.17.0
