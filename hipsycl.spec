...
%define pkg_base_name hipsycl
%define MODULE_VAR    HIPSYCL
...
License: GPL
Url: https://github.com/illuhad/hipSYCL/releases
Group: TACC
...
whatis("URL:  https://github.com/illuhad/hipSYCL/releases")
%if "%{is_debug}" == "1"
setenv("TACC_%{MODULE_VAR}_DEBUG","1")
%endif

-- Create environment variables.
local hipsycl_dir           = "%{INSTALL_DIR}"

setenv( "TACC_%{MODULE_VAR}_DIR",       hipsycl_dir)
setenv( "TACC_%{MODULE_VAR}_BIN",       pathJoin( hipsycl_dir,"bin") )
setenv( "TACC_%{MODULE_VAR}_INC",       pathJoin( hipsycl_dir,"include") )
setenv( "TACC_%{MODULE_VAR}_LIB",       pathJoin( hipsycl_dir,"lib") )

prepend_path("PATH",            pathJoin(hipsycl_dir,"bin") )
prepend_path("LD_LIBRARY_PATH", pathJoin(hipsycl_dir,"lib") )
EOF
