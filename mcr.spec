...
append_path("PATH", "/opt/shared/mcr/9.5/bin")
append_path("LD_LIBRARY_PATH", "/opt/shared/mcr/9.5/bin/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/shared/mcr/9.5/runtime/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/shared/mcr/9.5/bin/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/shared/mcr/9.5/sys/os/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/shared/mcr/9.5/sys/java/jre/glnxa64/jre/lib/amd64/server")
append_path("LD_LIBRARY_PATH", "/opt/shared/mcr/9.5/sys/java/jre/glnxa64/jre/lib/amd64")

setenv ("TACC_MCR_DIR", "/opt/shared/mcr/9.5")
setenv ("XAPPLRESDIR", "/opt/shared/mcr/9.5/X11/app-defaults")
