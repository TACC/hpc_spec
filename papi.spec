...
# fix the "ambiguous python shebang" error
...
#------------------------
  ...
  cd libpfm4
  git checkout 790451411d481492b6a3b94077b543c3e68c6d2b
  cd ..

  export ARCH=x86_64
  ./configure --prefix=%{INSTALL_DIR} --with-perf_events
  sed -i 's/python/python3/' ./high-level/scripts/papi_hl_output_writer.py
  make -j 28
