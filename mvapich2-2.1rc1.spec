#
# $Id: mvapich2-1.9.spec 1656 2014-11-26 15:29:50Z carlos $
#

# version used for install path

%define myversion 2.1rc1
...
Packager: TACC - mclay@tacc.utexas.edu, carlos@tacc.utexas.edu, viennej@tacc.utexas.edu
...
# Fix the MPI wrapper build scripts to remove build-only flags.
