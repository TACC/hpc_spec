...
#### python stuff
####
export PYTHONLEVEL=%{python_major_version}
module load cmake
export BOOSTMODULE=boost
#/1.65
module use /opt/apps/intel19/python%{python_major_version}_%{python_minor_version}/modulefiles/
...
FENICS_VERSION=$(python%{python_major_version} -c"import ffc; print(ffc.__version__)")
# clone --branch=$FENICS_VERSION
( \
