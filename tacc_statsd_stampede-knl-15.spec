...
%build
./configure --bindir=%{_bindir} --sysconfdir=%{_sysconfdir} --disable-infiniband --enable-opa --enable-rabbitmq \
CPPFLAGS=-I/home1/02561/rtevans/opa-ff/builtinclude.OPENIB_FF.release LDFLAGS=-L/home1/02561/rtevans/opa-ff/builtlibs.OPENIB_FF.release
make
