...
module load cmake swig/3.0.12
#module use -a /opt/apps/intel18/modulefiles
module use -a /opt/apps/gcc7_3/modulefiles
module load boost
## VLE stopgap!
...
%if "%{comp_fam}" == "gcc"
  which gcc
  #module use /opt/apps/gcc7_3/modulefiles
  module load mkl
%else
  export MKLFLAG="-mkl"
%endif
...
source %{SPEC_DIR}/trilinos-plato.cmake || /bin/true
