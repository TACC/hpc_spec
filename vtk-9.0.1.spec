...
Note: set cmake variable OpenGL_GL_PREFERENCE to LEGACY when configuring your application with cmake. (-DOpenGL_GL_PREFERENCE:STRING=LEGACY) This insures correct openGL library linking. 
]])
...
--conflict vtk
depends_on("swr/20.0.5")

local SWRDIR = os.getenv("TACC_SWR_DIR") or " "
prepend_path("PATH",pathJoin(vtk_dir,"bin"))
prepend_path("LD_LIBRARY_PATH",pathJoin(vtk_dir,"lib64"))
prepend_path("LD_LIBRARY_PATH",pathJoin(SWRDIR,"lib"))
prepend_path("LD_LIBRARY_PATH",pathJoin(SWRDIR,"lib64"))
