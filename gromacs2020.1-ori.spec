#
# rpmbuild -bb --define 'is_intel19 1' --define 'is_impi 1' --define 'mpiV 19_5' gromacs2020.1.spec 2>&1 | tee gromacs2019.4.spec_ic+im1905#_r1_a.log
# rpmbuild -bb --define 'is_intel19 1' --define 'is_impi 1' --define 'mpiV 19_5' gromacs2020.1_gpu.spec 2>&1 | tee gromacs2019.6.log

# r=/admin/build/admin/rpms/frontera/RPMS/x86_64
#rpm -hiv --nodeps --relocate /tmprpm=/opt/apps    $r/tacc-gromacs-intel19-impi19_0-package-2020.1-1.el7.x86_64.rpm
#rpm -hiv --nodeps --relocate /tmpmod=/opt/apps $r/tacc-gromacs-intel19-impi19_0-modulefile-2020.1-1.el7.x86_64.rpm

#rpm -e tacc-gromacs-intel19-impi19_0-package-2020.1-1.el7.x86_64
#rpm -e tacc-gromacs-intel19-impi19_0-modulefile-2020.1-1.el7.x86_64
...
-DCMAKE_C_FLAGS="-std=gnu99 -O3 -xCORE-AVX2 -axCORE-AVX512 -g " \
...
-DCMAKE_EXE_LINKER_FLAGS=" -mkl=sequential" \
-DCMAKE_C_FLAGS="-std=gnu99 -O3 -xCORE-AVX2 -axCORE-AVX512 -mkl=sequential -g " \
-DCMAKE_CXX_FLAGS="-std=c++11 -O3 -xCORE-AVX2 -axCORE-AVX512 -mkl=sequential -g " \
...
# Single precision GPU-MPI-enabled mdrun
