...
Source:    nwchem-7.0.2-release.revision-b9985dfa-srconly.2020-10-12.tar.bz2
...
export LAPACK_LIB=" -L${MKLROOT}/lib/intel64 -lmkl_scalapack_lp64 -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -lmkl_blacs_intelmpi_lp64 -liomp5 -lpthread -lm -ldl"
...
sed -i 's/-xMIC-AVX512/-mavx2/g' $NWCHEM_TOP/src/config/makefile.h
#
