...
%post %{MODULEFILE}
ln -s %{INSTALL_DIR}/lib/python2.7/site-packages/mpl_toolkits/basemap /opt/apps/intel%{comp_version}/python/%{python_version}/lib/python2.7/site-packages/mpl_toolkits/basemap
...
%include post-defines.inc
%preun %{MODULEFILE}
unlink /opt/apps/intel%{comp_version}/python/%{python_version}/lib/python2.7/site-packages/mpl_toolkits/basemap
########################################
############ Do Not Remove #############
########################################
