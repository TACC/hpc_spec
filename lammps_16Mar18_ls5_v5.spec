...
%if %{?BUILD_PACKAGE}
  ...
  liblist="atc awpmd colvars compress      h5md kim linalg meam netcdf poems        quip smd voronoi"
...
- PACKAGES
  ...
  The following packages were not installed:
    ...
    GPU, KOKKOS, LATTE, MSCG, PYTHON, REAX, USER-MOLFILE, USER-QMMM, USER-VTK
...
setenv("TACC_KIM_DIR"              ,"/opt/apps/gcc7_3/cray_mpich_7_7/kim/1.9.6/kim-api")
...
append_path("PATH","/opt/apps/gcc7_3/cray_mpich_7_7/kim/1.9.6/kim-api/bin")
