...
Source:    %{pkg_base_name}-release-%{pkg_version}.tar.gz
Source1:   %{pkg_base_name}-externals-release-%{external_pkg_version}.tar.gz
...
pwd
cd %{pkg_base_name}-externals-release-%{external_pkg_version}
pwd
mkdir -p BUILD
mkdir -p INSTALL
cd BUILD
