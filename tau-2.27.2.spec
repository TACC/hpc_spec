...
## rpmbuild -bb --clean --define 'is_intel18 1' --define 'is_impi 1' --define 'mpiV 18_2' tau-2.27.2.spec 2>&1 | tee tau-2.27.2_intel18_r2_a.log
#
#                    r=/admin/build/admin/rpms/stampede2/RPMS/x86_64
# rpm -hiv --nodeps $r/tacc-tau-intel18-impi18_0-package-2.27.2-1.el7.centos.x86_64.rpm
# rpm -hiv --nodeps $r/tacc-tau-intel18-impi18_0-modulefile-2.27.2-1.el7.centos.x86_64.rpm
