#
# rpmbuild -bb --define 'is_intel18 1' --define 'is_cmpich 1' --define 'mpiV 7_7_3' gromacs2019.3.spec 2>&1 | tee gromacs2019.3.spec_r#_a.log

# r=/admin/build/admin/rpms/frontera/RPMS/x86_64
#rpm -hiv --nodeps --relocate /tmprpm=/opt/apps $r/tacc-gromacs-intel18-cray_mpich_7_7-package-2019.3-1.x86_64.rpm
#rpm -hiv --nodeps --relocate /tmpmod=/opt/apps $r/tacc-gromacs-intel18-cray_mpich_7_7-modulefile-2019.3-1.x86_64.rpm
...
%define pkg_base_name gromacs-gpu
...
Packager:  TACC - staff Albert Lu alu@tacc.utexas.edu
Source:    gromacs-%{pkg_version}.tar.gz
...
TACC_%{MODULE_VAR}_INC for the location of the %{pkg_base_name} distribution, binaries,
...
It can be invoked in a job script with the command:
 ...
 ibrun mdrun_mpi_gpu -s topol.tpr -o traj.trr -c confout.gro -e ener.edr -g md.log
...
You must load cuda/9.0 to use this GPU version of Gromacs.
