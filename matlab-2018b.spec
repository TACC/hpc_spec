# $Id: matlab.spec, v2018b, 2018/10/26 siliu $ 
...
whatis("Name: MATLAB")
whatis("Version: 2018b")
whatis("Category: library, mathematics")
whatis("Keywords: Library, Mathematics, Tools")
whatis("URL: http://www.mathworks.com/")
whatis("Description: Matlab 2018b from MathWorks")

append_path("PATH", "/opt/apps/matlab/2018b/bin")

append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2018b/bin/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2018b/runtime/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2018b/sys/java/jre/glnxa64/jre/lib/amd64/server")

setenv ("TACC_MATLAB_DIR", "/opt/apps/matlab/2018b")
