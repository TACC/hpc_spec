...
%define underscore_version 2_3_6
...
setenv( "TACC_MPI_DIR"          , base_dir                                )
setenv( "TACC_MV2_DIR"          , base_dir                                )
setenv( "TACC_MV2_BIN"          , pathJoin( base_dir , "bin"      ) )
setenv( "TACC_MV2_LIB"          , pathJoin( base_dir , "lib"      ) )
...
prepend_path( "MODULEPATH", "/opt/apps/intel17/impi17_0/modulefiles")
family("MPI")
