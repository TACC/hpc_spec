...
# rpmbuild -bb --define 'is_intel19 1' --define 'is_impi 1' --define 'mpiV 19_4' gamess-2018.02.14.spec 2>&1 | tee gamess-2018.02.14_#a.log

# r=/admin/build/admin/rpms/frontera/RPMS/x86_64
#rpm -hiv --nodeps $r/tacc-gamess-intel19-impi19_0-package-2018.02.14-1.el7.x86_64.rpm
#rpm -hiv --nodeps $r/tacc-gamess-intel19-impi19_0-modulefile-2018.02.14-1.el7.x86_64.rpm
