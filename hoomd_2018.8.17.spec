...
%if %{?BUILD_PACKAGE}
  ...
  cmake ../ -DCMAKE_INSTALL_PREFIX=../../hoomd/lib/python3 \
            -DCMAKE_CXX_COMPILER="/opt/intel/compilers_and_libraries_2017.4.196/linux/mpi/intel64/bin/mpicxx" \
            -DCMAKE_C_COMPILER="/opt/intel/compilers_and_libraries_2017.4.196/linux/mpi/intel64/bin/mpicc"  \
            ...
            -DENABLE_CUDA=OFF -DENABLE_MPI=ON -DPYTHON_EXECUTABLE="/opt/apps/intel17/python3/3.6.3/bin/python3" \
...
prepend_path("PYTHONPATH",            pathJoin(hoomd_dir,"lib/python3/hoomd"))
EOF
