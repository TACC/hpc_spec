#
# Kent Milfeld  rpmbuild -bb mkmod.spec 2>&1 | tee mkmod-2.0.log
# 2018-11-13
#
...
# rpmbuild -bb mkmod.spec 2>&1 | tee mkmod-2.0_r1_a.log

# rpm -hiv --relocate /tmprpm=/opt/apps $r/tacc-mkmod-package-2.0-1.x86_64.rpm
# rpm -hiv --relocate /tmpmod=/opt/apps $r/tacc-mkmod-modulefile-2.0-1.x86_64.rpm

# rpm -e tacc-mkmod-package-2.0-1
# rpm -e tacc-mkmod-modulefile-2.0-1
...
USAGE:
     ...
     module load mkmod
     export VER=<ver> NAME=<app_name> TOPDIR=<top_level_directory_path>
     mkmod
...
setenv( "TACC_MKMOD_VER",  "%{pkg_version}" )
setenv( "MKMOD_HOME",      "%{INSTALL_DIR}" )
setenv( "MKMODHOME",       "%{INSTALL_DIR}" )
