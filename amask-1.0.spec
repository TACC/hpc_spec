...
# rpmbuild -bb --define 'is_intel19 1' --define 'is_impi 1' --define 'mpiV 19_0' amask-1.0.spec 2>&1 | tee amask-1.0_ic_im1905_r1.log
# r=/admin/build/admin/rpms/ls6/RPMS/x86_64
# rpm -hiv --relocate /tmprpm=/opt/apps  $r/tacc-amask-intel19-impi19_0-package-1.0-1.el8.x86_64.rpm
# rpm -hiv --relocate /tmpmod=/opt/apps  $r/tacc-amask-intel19-impi19_0-modulefile-1.0-1.el8.x86_64.rpm
