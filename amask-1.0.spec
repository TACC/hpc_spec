# build rpm
#alias reloc="rpm -U --nodeps --relocate /tmprpm=/opt/apps"

#BUILD:
# rpmbuild -bb --clean  --define 'is_intel18 1' --define 'is_cmpich 1' --define 'mpiV 7_7_3' amask-1.0.spec   2>&1 | tee amask-1.0.r#_x.log
...
# rpm -e tacc-amask-intel18-cray_mpich_7_7-modulefile-1.0-1
