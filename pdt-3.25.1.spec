...
## rpmbuild -bb --define 'is_intel18 1'  pdt-3.25.1.spec 2>&1 | tee pdt-3.25.1_intel18_r1_a.log
...
#  rpm -hiv --nodeps $r/tacc-pdtoolkit-intel18-package-3.25.1-1.el7.x86_64.rpm
#  rpm -hiv --nodeps $r/tacc-pdtoolkit-intel18-modulefile-3.25.1-1.el7.x86_64.rpm
