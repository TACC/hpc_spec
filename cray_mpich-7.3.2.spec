...
Group: Development/Tools
%description package
This package provides Cray Message Passing Toolkit 7.3.2, a Cray 
...
This modulefile provides access to the Cray Message Passing Toolkit 7.3.2

%description
This module provides access to the Cray Message Passing Toolkit 7.3.2, a Cray 
...
-- Modified to support 7.3.0 as default for a time
-- local mpt_version = "default"
local mpt_version = "7.3.2"
...
%if "%{comp_fam}" == "intel"
local comp_dir  = "mpich-intel/15.0"
local full_path = pathJoin( mpt_path, comp_dir ) 
