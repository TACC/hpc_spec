...
# cd ../RPMS/x86_64
# NO_PACKAGE=1 ./build_rpm.sh --gcc=91   mkl-19.1.1.spec
# rpm -i --relocate /tmpmod=/opt/apps tacc-mkl-gcc9_1-modulefile-19.1.1-1.el8.x86_64.rpm
# rpm -e Bar-package-1.1-1.x86_64 tacc-mkl-gcc9_1-modulefile-19.1.1-1.el8
