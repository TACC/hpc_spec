...
#%global pmix_version 3.1.4
#%global ucx_version  1.6.1
#%global hwloc_version 1.11.13
#%global _with_pmix --with-pmix=/opt/apps/pmix/%{pmix_version}
#%global _with_ucx  --with-ucx=/opt/apps/ucx/%{ucx_version}
#%global _with_hwloc --with-hwloc=/opt/apps/hwloc/%{hwloc_version}
#%global _with_numa 1
#%global _with_lua 1
...
%bcond_with numa
%bcond_with x11
%bcond_with pmix /opt/apps/pmix/%{pmix_version}
