...
%if "%{has_netcdf}" == "1"
  ...
  module load netcdf
  export HAS_SEACAS=${HAS_STK}
  # STKIO depends on SEACASIoss
  export HAS_STKIO=ON
%else
  echo "no netcdf"
  export HAS_NETCDF=OFF
  export HAS_SEACAS=OFF
  export HAS_STKIO=OFF
%endif
...
%changelog
* Mon Oct 11 2021 eijkhout <eijkhout@tacc.utexas.edu>
- release 2: adding yaml-cpp
* Fri Oct 01 2021 eijkhout <eijkhout@tacc.utexas.edu>
