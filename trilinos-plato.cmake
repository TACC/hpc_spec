cmake -VV \
  ...
  \
  -D CMAKE_INSTALL_PREFIX:PATH=${PREFIXPATH} \
  ...
  ` if [ "${HAS_PYTHON}" = "ON" ]  then \
    echo "-D Trilinos_EXTRA_LINK_FLAGS=\"${TACC_PYTHON2_LIB}/libpython2.7.so\" \
          -D Trilinos_EXTRA_LD_FLAGS=\"${TACC_PYTHON2_LIB}/libpython2.7.so\" " \
    fi ` \
  \
  ...
  -D Trilinos_ENABLE_Kokkos:BOOL=ON \
    ...
    -D Kokkos_ENABLE_Cuda:BOOL=${HAS_CUDA} \
    -D Kokkos_ENABLE_Cuda_Lambda:BOOL=${HAS_CUDA} \
    -D NEXT_OPTION_CONTRARY_TO_PLATO:BOOL=OFF \
