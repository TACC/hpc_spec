...
wget "http://dl.fedoraproject.org/pub/epel/6/x86_64/R-core-3.2.1-2.el6.x86_64.rpm"
# we also need libicu-4.2.1
wget "http://mirror.centos.org/centos/6/os/x86_64/Packages/libicu-4.2.1-12.el6.x86_64.rpm"

rpm2cpio rstudio-server-rhel-0.99.473-x86_64.rpm | cpio -idmv
rpm2cpio R-core-3.2.1-2.el6.x86_64.rpm | cpio -idmv
rpm2cpio libicu-4.2.1-12.el6.x86_64.rpm | cpio -idmv
