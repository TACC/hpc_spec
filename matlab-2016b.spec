...
prepend_path("PATH", "/opt/apps/matlab/2016b/bin")

append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2016b/bin/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2016b/runtime/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2016b/sys/java/jre/glnxa64/jre/lib/amd64/server")

setenv ("TACC_MATLAB_DIR", "/opt/apps/matlab/2016b")
