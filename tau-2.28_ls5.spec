## rpmbuild -bb --clean --define 'is_intel18 1' --define 'is_cmpich 1' --define 'mpiV 7_7_3' tau-2.28.spec 2>&1 | tee tau-2.28_intel18_r2_a.log
## rpmbuild -bb --clean --define 'is_intel18 1' --define 'is_cmpich 1' --define 'mpiV 7_7_3' tau-2.28.spec |& tee tau-2.28_intel18_r2_a.log
#
#                    r=/admin/rpms/RPMS/x86_64
# rpm -hiv --nodeps $r/tacc-tau-intel18-cray_mpich_7_7-package-2.28-1.x86_64.rpm
# rpm -hiv --nodeps $r/tacc-tau-intel18-cray_mpich_7_7-modulefile-2.28-1.x86_64.rpm
...
TAU_MAKEFILE environement variable. The syntax for makefile name is:
    ...
    <path>/Makefile.tau-<tag>-<hyphen_separated_component_list>\n

where the tag is either for intelomp (for openmp-only) codes and intelmpi
(for mpi with/without openmp) codes using intel OpenMP and MPI;
