...
#------------------------
  ...
  ./bootstrap.sh --with-python=/opt/apps/intel18/python3/3.7.0/bin/python3.7  --with-python-version=3.7 --with-python-root=/opt/apps/intel18/python3/3.7.0 --prefix=%{PYTHON_INSTALL_DIR} ${CONFIGURE_FLAGS}
