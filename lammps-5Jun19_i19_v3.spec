...
#
# rpmbuild -bb --define 'is_intel19 1' --define 'is_impi 1' --define 'mpiV 19_5' lammps-5Jun19_i19_v3.spec | tee log_lammps_5Jun19
...
%if %{?BUILD_PACKAGE}
  ...
  #liblist=""
  liblist="atc awpmd colvars compress      kim linalg       plumed poems python         scafacos  smd voronoi    ffmpeg"
...
EOF
  ...
  if [[ $liblist =~ "kim" ]]; then
    ...
    mkdir -p /home1/apps/intel19/impi19_0/lammps/%{major_version}/lib/kim
    ...
    mv kim-api-${KIM_VERSION} /home1/apps/intel19/impi19_0/lammps/%{major_version}/lib/kim
    cd /home1/apps/intel19/impi19_0/lammps/%{major_version}/lib/kim
...
EOF
    ...
    cp -r /home1/apps/intel19/impi19_0/lammps/%{major_version}/lib/kim/installed-kim-api .
...
EOF
  ...
  rm -rf /home1/apps/intel19/impi19_0/lammps/%{major_version}
...
%if %{?BUILD_PACKAGE}
  ...
  rm -rf lib/qmmm lib/reax lib/h5md lib/netcdf lib/quip lib/vtk
...
TACC_LAMMPS_DIR/BIN/LIB/POT/PYTHON

for the location of the LAMMPS home, binaries, libraries, potentials, 
and python scripts respectively. The modulefile also appends TACC_LAMMPS_BIN to PATH.

- PACKAGES

The following packages were not installed:

  GPU, H5MD, KOKKOS, LATTE, MESSAGE, MSCG, NETCDF, QUIP, REAX, USER-ADIOS USER-MOLFILE, USER-QMMM, USER-VTK
