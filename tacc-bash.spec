...
Obsoletes: bash 
#Provides: %{pkg_base_name} = %{version}-%{release}.%{?dist}
#Provides: %{name} = %{version}-%{release}.%{?dis}
Provides: /bin/sh
Provides: /bin/bash

Provides: bash = 4.2.46-29.el7_4
Provides: bash(x86-64) = 4.2.46-29.el7_4
Provides: config(bash) = 4.2.46-29.el7_4
Provides: tacc-bash = 4.2.46-29.el7_4
Provides: tacc-bash(x86-64) = 4.2.46-29.el7_4
Provides: config(bash) = 4.2.46-29.el7_4
