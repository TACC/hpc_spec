...
append_path("PATH", "/opt/apps/matlab/2018a/bin")

append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2018a/bin/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2018a/runtime/glnxa64")
append_path("LD_LIBRARY_PATH", "/opt/apps/matlab/2018a/sys/java/jre/glnxa64/jre/lib/amd64/server")

setenv ("TACC_MATLAB_DIR", "/opt/apps/matlab/2018a")
