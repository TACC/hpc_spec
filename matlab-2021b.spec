...
whatis("Name: MATLAB")
whatis("Version: 2021b")
whatis("Category: library, mathematics")
whatis("Keywords: Library, Mathematics, Tools")
whatis("URL: http://www.mathworks.com/")
whatis("Description: Matlab 2021b from MathWorks")

append_path("PATH", "/scratch/tacc/apps/matlab/2021b/bin")

append_path("LD_LIBRARY_PATH", "/scratch/tacc/apps/matlab/2021b/bin/glnxa64")
append_path("LD_LIBRARY_PATH", "/scratch/tacc/apps/matlab/2021b/runtime/glnxa64")
append_path("LD_LIBRARY_PATH", "/scratch/tacc/apps/matlab/2021b/sys/java/jre/glnxa64/jre/lib/amd64/server/")

setenv ("TACC_MATLAB_DIR", "/scratch/tacc/apps/matlab/2021b")
