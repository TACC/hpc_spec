...
if ! $(%{INSTALL_DIR_COMP}/bin/%{PNAME} -c "import numpy"); then
	...
	wget https://github.com/numpy/numpy/releases/download/v1.16.2/numpy-1.16.2.tar.gz
    fi	   
    
    rm -rf %{_topdir}/SOURCES/numpy-1.16.2 	   
    tar -xzvf %{_topdir}/SOURCES/numpy-1.16.2.tar.gz -C %{_topdir}/SOURCES	
    cd %{_topdir}/SOURCES/numpy-1.16.2
